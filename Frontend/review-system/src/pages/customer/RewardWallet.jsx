...
const styles = {
    ...
    paymentButton: { flex: 1, padding: '1rem', backgroundColor: 'var(--hero-bg)', border: '2px solid var(--card-border)', borderRadius: '8px', color: 'var(--text-color)', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', transition: 'all 0.2s ease-in-out', fontWeight: '500' },
    paymentButtonActive: { borderColor: 'var(--button-bg)', color: '#fff', backgroundColor: 'var(--button-bg)', boxShadow: '0 0 10px rgba(59, 130, 246, 0.4)' },
